                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                <a href="{{ route('role.edit', $role) }}"
                                                    ...
                                                    <button
                                                        class="px-3 py-1 bg-indigo-500 text-white rounded hover:bg-indigo-600">Edit</button>
                                                </a>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-6 py-4 text-center text-gray-500 text-sm">
                                            No roles found. <a href="{{ route('role.create') }}"
                                                class="text-blue-600 hover:underline">Create your first role</a>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
